...
// const y = undefined;
// let z; //initialized but also undefined

// console.log(typeof name);
// console.log(typeof age3);
// console.log(typeof rating); //no floats or decimals, etc.
// console.log(typeof isCool);
// console.log(typeof x); //-> object (bogus(netikras) typeof return value). 
...
// //Arrays - var. that holds multiple values.
// //new x - constructor
...
//     return toDo.text;
// });
// console.log(toDoCompleted); //returns completed (true) elements' text.
...
// if (y < 10 || z < 10) {
//     console.log('y is less than 10 or z is less than 10')
// } else if (y === 10 && z === 10) {
//     console.log('y is equal to 10 or z is equal to 10')
// } else {
//     console.log('y is more than 10 or z is more than 10')
// }
...
// const addNumbers = (num1 = 4, num2 = 1) => num1 + num2;

// console.log(addNumbers()); //->5


// //Arrow function with one parameter:
// const addNumbers2 = num1 => num1 + 4;

// console.log(addNumbers2(9)); //->13
